        ...
        <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form class="w-full">
            ...
            >
              ...
              <button
                class="mt-1 w-full bg-indigo-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-gray-600 sm:mt-0 sm:w-auto sm:flex-shrink-0"
              >
                Sign Up
              </button>
            </div>
