...
export default function Footer() {
  return (
    <footer
      ...
      class="bg-white static bottom-0 left-0 right-0"
    >
        ...
        <div class="mx-auto max-w-md">
          ...
          <form class="mt-6">
            <div class="relative max-w-lg">
              ...
              <button class="absolute top-1/2 right-1 -translate-y-1/2 rounded-full bg-blue-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700">
                Subscribe
              </button>
            </div>
          </form>
